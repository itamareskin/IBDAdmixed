...
#         if "CEU" in pop_file:
#             pop.removeIndividuals(range(30,pop.popSize()))
        first = False;
    else:
...
pop_train = create_artificial_pop(pop_train_base,100,0,0)
pop_test = create_artificial_pop(pop_train_base,200,80,0.005)
