...
setup(
    ...
    ext_modules = [Extension("utils.StringUtils", ["utils/StringUtils.pyx"], language="c++", extra_compile_args=["-O3"]), 
                   ...
                   Extension("utils.FormatConversions", ['utils/FormatConversions.pyx', 'utils/ped_to_bgl.cpp', 'utils/ped_to_lamp.cpp'], language="c++", include_dirs=['.'], extra_compile_args=["-O3"]),
