...
setup(
    ...
    ext_modules = [Extension("utils.StringUtils", ["utils/StringUtils.pyx"], language="c++", extra_compile_args=["-O3"]), 
                   ...
                   Extension("IBD.intersection", ["IBD/intersection.pyx"], language="c++", include_dirs=['.'], extra_compile_args=["-O3"]),
                   Extension("IBD.cIBD", ["IBD/cIBD.pyx", "IBD/intervalItem.cpp"], language="c++", include_dirs=['.', 'IBD'], extra_compile_args=["-O3"]), 
